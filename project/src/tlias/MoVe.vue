<template>
            ...
            <el-main>
              <el-form :inline="true" :model="searchForm" class="demo-form-inline">
                <el-form-item label="移库单号">
                  <el-input v-model="searchForm.moveid" placeholder="移库单号"></el-input>
                </el-form-item>
                <el-form-item label="商品号">
                  <el-input v-model="searchForm.goodsid" placeholder="商品号"></el-input>
                </el-form-item>
                <el-form-item label="移入仓库号">
                  <el-input v-model="searchForm.win" placeholder="移入仓库号"></el-input>
                </el-form-item>
                <el-form-item label="移出仓库号">
                  <el-input v-model="searchForm.wout" placeholder="移出仓库号"></el-input>
                </el-form-item>
                <el-form-item>
              ...
              <el-table :data="tableData" border >
                <el-table-column prop="moveid" label="出库单号" >
                </el-table-column>
                <el-table-column prop="movetime" label="出库时间">
                </el-table-column>
                <el-table-column prop="eno" label="职工号">
                </el-table-column>
                <el-table-column prop="goodsid" label="商品号">
                </el-table-column>
                <el-table-column prop="win" label="移入仓库号">
                </el-table-column>
                <el-table-column prop="wout" label="移出仓库号">
                </el-table-column>             
                  <el-table-column prop="movenum" label="数量">
                </el-table-column>
  ...
  <template slot-scope="scope">
    <div class="button-container">
      ...
      <el-button type="danger" size="mini" @click="confirmDelete(scope.row)">删除</el-button>
          ...
          <el-dialog title="新增移库信息" :visible.sync="addDialogVisible" width="30%">
            <el-form :model="move" :rules="addFormRules" ref="addForm" label-width="100px">
              <el-form-item label="出库单号" prop="moveid">
                <el-input v-model="move.moveid"></el-input>
              </el-form-item>
              <el-form-item label="商品号" prop="goodsid">
  <el-input v-model="move.goodsid"></el-input>
</el-form-item>
              <el-form-item label="移出仓库号" prop="wout">
                <el-input v-model="move.wout"></el-input>
              </el-form-item>
              <el-form-item label="移入仓库号" prop="win">
                <el-input v-model="move.win"></el-input>
              </el-form-item>
              <el-form-item label="数量" prop="movenum">
                <el-input v-model="move.movenum"></el-input>
              </el-form-item>
              <el-form-item label="移库时间" prop="movetime">
                <el-date-picker v-model="move.movetime" type="date"></el-date-picker>
              </el-form-item>
              <el-form-item label="职工号" prop="eno">
                <el-input v-model="move.eno"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
              <el-button @click="addDialogVisible = false">取消</el-button>
              <el-button type="primary" @click="addmove">确认新增</el-button>
            </div>
          </el-dialog>
  ...
  methods: {
    getData() {
      // 发送异步请求，获取数据
      axios.get('http://localhost:8081/move').then((result) => {
    ...
    onSubmit() {
  const { moveid,goods_id,win,wout } = this.searchForm;
  const params = {
  ...
  axios.get('http://localhost:8081/move1', { params })
    .then(response => {
      // 处理获取到的数据
    ...
    deleteEmployee() {
      const  moveid = this.currentDeleteRow. moveid;
      const goodsid = this.currentDeleteRow.goodsid;
      const win = this.currentDeleteRow.win;
      const wout = this.currentDeleteRow.wout;
      // 发送异步请求删除数据
      axios
      .delete(`http://localhost:8081/move/${moveid}/${goodsid}/${win}/${wout}`)
        .then(() => {
          // 处理删除成功的逻辑
          console.log('删除成功');
          // 重新获取数据
    ...
    addmove() {
  axios
    .post('http://localhost:8081/move', this.move)
    .then(() => {
      // 处理添加成功的逻辑
      console.log('添加成功');
      // 关闭新增对话框
