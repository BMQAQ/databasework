        ...
        <el-main>
          <el-form :inline="true" :model="searchForm" class="demo-form-inline">
            ...
            <el-form-item label="电话">
              <el-input v-model="searchForm.wphone" placeholder="电话"></el-input>
            </el-form-item>
            <el-form-item>
          ...
          <el-table :data="tableData" border>
            ...
            <el-table-column prop="wadress" label="地址">
            </el-table-column>
            <el-table-column prop="wphone" label="电话">
            </el-table-column>
            <el-table-column prop="wmanager" label="仓库管理员">
            </el-table-column>
          ...
          <el-dialog title="新增仓库" :visible.sync="addDialogVisible" width="30%">
            <el-form :model="addForm" label-width="100px">
              <el-form-item label="仓库号">
                <el-input v-model="addForm.wno"></el-input>
              </el-form-item>
              <el-form-item label="地址">
                <el-input v-model="addForm.wadress"></el-input>
              </el-form-item>
              <el-form-item label="电话">
                <el-input v-model="addForm.wphone"></el-input>
              </el-form-item>
              <el-form-item label="仓库管理员">
                <el-input v-model="addForm.wmanager"></el-input>
              </el-form-item>
            </el-form>
...
export default {
  ...
  methods: {
    getData() {
      // 发送异步请求，获取数据
      axios.get('http://localhost:8081/warehouse').then((result) => {
    ...
    onSubmit() {
      const { wno, wphone } = this.searchForm;
const params = {
...
axios.get('http://localhost:8081/warehouse1', { params })
  .then(response => {
    // 处理获取到的数据
  ...
  .catch(error => {
    ...
    deleteEmployee() {
      ...
      // 发送异步请求删除数据
      axios
        .delete(`http://localhost:8081/goods_sales/${wno}`)
        .then(() => {
          // 处理删除成功的逻辑
          console.log('删除成功');
          // 重新获取数据
    ...
    // 发送异步请求添加员工数据
    axios
      .post('http://localhost:8081/warehouse', this.addForm)
      .then(() => {
        // 处理添加成功的逻辑
        console.log('添加成功');
        // 关闭新增员工弹窗
