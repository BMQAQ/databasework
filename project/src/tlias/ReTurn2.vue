<template>
            ...
            <el-main>
              <el-form :inline="true" :model="searchForm" class="demo-form-inline">
                <el-form-item label="退货单号">
                  <el-input v-model="searchForm.rono" placeholder="退货单号"></el-input>
                </el-form-item>
              ...
              <el-table :data="tableData" border >
                <el-table-column prop="rono" label="退货单号" >
                </el-table-column>
                <el-table-column prop="rotime" label="退货时间">
                </el-table-column>
                ...
                <el-table-column prop="ronum" label="退货数量">
                </el-table-column>
  ...
  <template slot-scope="scope">
    <div class="button-container">
      ...
      <el-button type="danger" size="mini" @click="confirmDelete(scope.row)">删除</el-button>
          ...
          <el-dialog title="新增退货信息" :visible.sync="addDialogVisible" width="30%">
            <el-form :model="Return" :rules="addFormRules" ref="addForm" label-width="100px">
              <el-form-item label="退货单号" prop="rono">
                <el-input v-model="Return.rono"></el-input>
              </el-form-item>
              <el-form-item label="商品号" prop="goodsid">
  <el-input v-model="Return.goodsid"></el-input>
</el-form-item>
              <el-form-item label="退货仓库号" prop="wno">
                <el-input v-model="Return.wno"></el-input>
              </el-form-item>
              <el-form-item label="数量" prop="ronum">
                <el-input v-model="Return.ronum"></el-input>
              </el-form-item>
              <el-form-item label="原因" prop="reason">
                <el-input type="textarea" autosize placeholder="请输入内容" v-model="Return.reason"></el-input>
              </el-form-item>
              <el-form-item label="退货时间" prop="rotime">
                <el-date-picker v-model="Return.rotime" type="date"></el-date-picker>
              </el-form-item>
              <el-form-item label="职工号" prop="eno">
                <el-input v-model="Return.eno"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
              <el-button @click="addDialogVisible = false">取消</el-button>
              <el-button type="primary" @click="addreturn">确认新增</el-button>
            </div>
          </el-dialog>
  ...
  methods: {
    getData() {
      // 发送异步请求，获取数据
      axios.get('http://localhost:8081/return').then((result) => {
    ...
    onSubmit() {
      console.info("密码是"+this.Eno)
  const { ROno,goods_id } = this.searchForm;
  const params = {
  ...
  axios.get('http://localhost:8081/return1', { params })
    .then(response => {
      // 处理获取到的数据
    ...
    deleteEmployee() {
      const  rono = this.currentDeleteRow. rono;
      const goodsid = this.currentDeleteRow.goodsid;
      // 发送异步请求删除数据
      axios
      .delete(`http://localhost:8081/return/${rono}/${goodsid}`)
        .then(() => {
          // 处理删除成功的逻辑
          console.log('删除成功');
          // 重新获取数据
    ...
    addreturn() {
  axios
    .post('http://localhost:8081/return', this.Return)
    .then(() => {
      // 处理添加成功的逻辑
      console.log('添加成功');
      // 关闭新增对话框
