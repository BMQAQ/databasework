 ...
 * @Date: 2023-06-Sa 11:26:25 
 * @Last Modified by:   mikey.zhaopeng 
 * @Last Modified time: 2023-06-Sa 11:26:25 
 */
<template>
  <div>
        ...
        <el-main>
          <el-form :inline="true" :model="searchForm" class="demo-form-inline">
            <el-form-item label="销售单号">
              <el-input v-model="searchForm.saleid" placeholder="销售单号"></el-input>
            </el-form-item>
            <el-form-item label="商品号">
              <el-input v-model="searchForm.goodsid" placeholder="商品号"></el-input>
            </el-form-item>
            <el-form-item label="仓库号">
              <el-input v-model="searchForm.wno" placeholder="仓库号"></el-input>
            </el-form-item>
            <el-form-item label="起始时间">
              <el-date-picker v-model="searchForm.begin" type="date" placeholder="起始时间"></el-date-picker>
            </el-form-item>
            <el-form-item label="截止时间">
              <el-date-picker v-model="searchForm.end" type="date" placeholder="截止时间"></el-date-picker>
            </el-form-item>
            <el-form-item>
          ...
          <el-dialog title="新增销售信息" :visible.sync="addDialogVisible" width="30%">
            <el-form :model="sales" :rules="addFormRules" ref="addForm" label-width="100px">
              <el-form-item label="销售单号" prop="saleid">
                <el-input v-model="sales.saleid"></el-input>
              </el-form-item>
              <el-form-item label="商品号" prop="goodsid">
                <el-input v-model="sales.goodsid"></el-input>
              </el-form-item>
              <el-form-item label="仓库号" prop="wno">
                <el-input v-model="sales.wno"></el-input>
              </el-form-item>
              <el-form-item label="销售数量" prop="salenum">
                <el-input v-model="sales.salenum"></el-input>
              </el-form-item>
              <el-form-item label="销售时间" prop="sotime">
                <el-date-picker v-model="sales.sotime" type="date"></el-date-picker>
              </el-form-item>
              <el-form-item label="职工号" prop="eno">
                <el-input v-model="sales.eno"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
              <el-button @click="addDialogVisible = false">取消</el-button>
              <el-button type="primary" @click="addsale">确认新增</el-button>
            </div>
          </el-dialog>
...
export default {
  ...
  // 发送异步请求，获取数据
  const params = {
    page: this.currentPage, // 添加 currentPage 参数
    pageSize: this.pageSize,
    // 其他查询参数...
  };
  axios.get('http://localhost:8081/goods_sales', { params }).then((result) => {
...
onSubmit() {
  const { saleid,goodsid,wno,begin,end } = this.searchForm;
  const params = {
  ...
  axios.get('http://localhost:8081/goods_sales1', { params })
    .then(response => {
      // 处理获取到的数据
 ...
 confirmDelete(row) {
    ...
    deleteEmployee() {
      const saleid = this.currentDeleteRow.saleid;
      const goodsid = this.currentDeleteRow.goodsid;
      // 发送异步请求删除数据
      axios
        .delete(`http://localhost:8081/goods_sales/${saleid}/${goodsid}`)
        .then(() => {
          // 处理删除成功的逻辑
          console.log('删除成功');
          // 重新获取数据
    ...
    addsale() {
  axios
    .post('http://localhost:8081/goods_sales', this.sales)
    .then(() => {
      // 处理添加成功的逻辑
      console.log('添加成功');
      // 关闭新增对话框
