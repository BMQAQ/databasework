<template>
  ...
  <el-container style="height: 500px; border: 1px solid #eee">
    ...
    <el-container>
      ...
      <el-table-column prop="photo" label="照片" width="400" >
        <template slot-scope="scope1">
        <img :src="scope1.row.photo" width="100" height="100">
      </template>
      </el-table-column>
  ...
  methods: {
    ...
    getData() {
      ...
      axios.get('http://localhost:8081/employee').then((result) => {
        ...
        console.info("路径是"+this.tableData.photo);
        // 更新总记录数
